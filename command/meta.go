...
func (m *Meta) Env() string {
	current, _ := m.EnvWithIsOverridden()
	return current
}

// Env returns the name of the currently configured environment, corresponding
// to the desired named state, as well as a bool saying whether this was
// set via the TF_ENVIRONMENT environment variable.
func (m *Meta) EnvWithIsOverridden() (string, bool) {
